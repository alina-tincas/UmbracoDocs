...
![Deploy from Local to Remote](../.gitbook/assets/stage-commit-deploy\_v10.gif)
...
The dashboard will show the status based on the marker files on the disk, eg. `deploy-progress`. From the **Deploy** Dashboard, it is also possible to trigger different processes. Learn more about this dashboard in the [Deployment](deployment.md) article.
