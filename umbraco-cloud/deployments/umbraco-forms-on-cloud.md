...
Read more about the product in the [Umbraco Forms](https://github.com/alina-tincas/UmbracoDocs/blob/main/umbraco-forms/overview.md) section.
...
Umbraco Forms is part of the [auto-upgrades on Umbraco Cloud](https://github.com/alina-tincas/UmbracoDocs/blob/main/umbraco-cloud/upgrades/README.md). Whenever a new patch is ready for release, we will automatically apply it to your Cloud project. There will be a notification in the Umbraco Cloud Portal at least 5 days before we roll out new versions.
