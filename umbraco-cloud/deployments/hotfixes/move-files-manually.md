...
1. Clone down the Live environment.
   *   The _clone URL_ for the Live environment can be found in the Umbraco Cloud Portal:
       ...
       <figure><img src="../../.gitbook/assets/live-clone-URL_v10.png" alt=""><figcaption><p>Live Clone URL</p></figcaption></figure>

       ![](https://github.com/alina-tincas/UmbracoDocs/blob/main/umbraco-cloud/deployment/hotfixes/images/live-clone-url\_v10.png)
