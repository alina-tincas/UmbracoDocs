...
4. [Partial Restore](https://github.com/alina-tincas/UmbracoDocs/blob/main/umbraco-cloud/deployment/restoring-content/Partial-Restore/README.md)
...
![Workspace Restore](../../.gitbook/assets/Workspace\_Restore.gif)
