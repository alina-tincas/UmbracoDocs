...
3. Select the desired **Multifactor Authentication Method** from the drop-down list. ![Edit Profile MFA](../.gitbook/assets/Edit\_Profile\_MFA.png)
...
![Phone authentication](<../.gitbook/assets/Phone-auth (1).png>)
