...
![Clone down Umbraco Cloud project](../../.gitbook/assets/connect-my-machine.png)
...
Once you have everything your site will need committed you can follow the [deployment workflow](../../deployments/deployment.md) to complete the deployment.
