...
3.  Select **Clone project**.
    ...
    ![Clone project option](../../.gitbook/assets/clone-project-option.png)
4.  **Copy** the clone URL to copy the Development environment's git repository endpoint.

    ![Copy the clone URL](../../.gitbook/assets/copy-clone-url.png)
...
6.  Type the following command in the **Git Bash** terminal:
    ...
    The `<Git clone URL>` should be the URL you copied from the Cloud Development environment. ![Git Bash Terminal](../../.gitbook/assets/git-bash-terminal.png)
7. Press **Enter**.
...
![Umbraco 9 files](../../.gitbook/assets/V9-files.png)

1.  Navigate to `src/UmbracoProject`. Here, you will find the files for your Umbraco installation.

    ![Umbraco 9 files](../../.gitbook/assets/V9-project-file.png)
2. Open the `UmbracoProject.csproj` file in Visual Studio.
3. Build and run your solution in Visual studio.

You can create content, add media, and create your custom code. When you're ready to deploy your changes make sure to have a look at the [deployments](../../deployments/deployment.md) documentation.
...
2.  Click on the solution:
    ...
    ![Solution](../../.gitbook/assets/solution-VS.png)
3.  Right-click the solution and choose `Add` -> `New Project...`

    ![add new project](../../.gitbook/assets/add-new.png)
4.  Add a class library using the latest .NET SDK to your project:

    ![Class library](../../.gitbook/assets/class-library.png)
