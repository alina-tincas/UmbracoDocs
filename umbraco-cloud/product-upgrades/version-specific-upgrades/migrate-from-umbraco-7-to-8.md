...
* Make sure Umbraco Forms data is not handled as content.
  * See [Umbraco Forms on Cloud](../../deployments/umbraco-forms-on-cloud.md#how-forms-are-handled-on-umbraco-cloud) for more details on how to check the setting.
...
![Authorize upgrade](../../.gitbook/assets/authorize-upgrade-to-8.png)
